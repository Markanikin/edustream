          ...
          <header className="flex justify-between items-center mb-12 md:mb-20">
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div className="flex items-center gap-2 md:gap-4 group">
                ...
                <h1 className="text-lg md:text-2xl font-black tracking-[0.1em] md:tracking-[0.2em] text-white uppercase">EduMind <span className="text-cyan-500">Core</span></h1>
              </div>
            </div>
            
            <a href="https://send.monobank.ua/jar/8LjZWeX9nK" target="_blank" className="hidden sm:block px-6 md:px-8 py-3 font-black text-cyan-400 border border-cyan-500/30 rounded-full hover:bg-cyan-500/10 transition-all backdrop-blur-md uppercase text-[10px] tracking-[0.2em]">
              Support
            </a>
          </header>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-10">
              <div className="flex flex-col items-center md:items-start space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] md:text-[11px] font-black text-green-500 uppercase tracking-[0.2em]">СИСТЕМА АКТИВОВАНА</span>
                </div>
              ...
              <div className="text-right text-[9px] md:text-[10px] text-slate-600 font-mono uppercase tracking-widest text-center md:text-right">
                © {new Date().getFullYear()} EduMind AI <br />
